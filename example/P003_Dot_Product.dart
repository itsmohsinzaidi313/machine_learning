...
List<double> dotProduct({required List<List<double>> weights, required List<double> inputs}) {
...
List<double> addVectors({required List<double> interOutputs, required List<double> biases}) {
  List<double> output = [];
